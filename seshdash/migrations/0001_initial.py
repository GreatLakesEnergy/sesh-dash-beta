# -*- coding: utf-8 -*-
# Generated by Django 1.9.1 on 2016-11-03 14:59
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('field_name', models.FloatField(choices=[(b'soc', b'State of Charge'), (b'battery_voltage', b'Battery Voltage'), (b'AC_Voltage_in', b'AC Voltage In'), (b'AC_Voltage_out', b'AC Voltage Out'), (b'AC_input', b'AC Input'), (b'AC_output', b'AC Output'), (b'AC_Load_in', b'AC Load in'), (b'AC_Load_out', b'AC Load out'), (b'pv_production', b'PV Production'), (b'main_on', b'Main On'), (b'relay_state', b'Relay State'), (b'trans', b' Trans'), (b'genset_state', b'Genset State'), (b'AC_output_absolute', b'AC Output absolute'), (b'minutes_last_contact', b'Minutes last Contact'), (b'daily_battery_charge', b'Daily Battery Charge'), (b'daily_grid_outage_n', b'Daily Grid Outage N'), (b'daily_grid_outage_t', b'Daily Grid Outage T'), (b'daily_grid_usage', b'Daily Grid Usage'), (b'daily_no_of_alerts', b'Daily Number of Alerts'), (b'daily_power_cons_pv', b'Daily Power Cons Pv'), (b'daily_power_consumption_total', b'Daily Power Consumption Total'), (b'daily_pv_yield', b'Daily Pv Yield'), (b'cloud_cover', b'Cloud Cover')], default=0, verbose_name=b'Data Point Name')),
                ('field_unit', models.FloatField(choices=[(b'id', b''), (b'soc', b'%'), (b'battery_voltage', b'V'), (b'AC_Voltage_in', b'V'), (b'AC_Voltage_out', b'V'), (b'AC_input', b'W'), (b'AC_output', b'W'), (b'AC_Load_in', b'A'), (b'AC_Load_out', b'A'), (b'cloud_cover', b'%'), (b'pv_production', b'W'), (b'main_on', b''), (b'relay_state', b''), (b'trans', b''), (b'genset_state', b''), (b'site', b''), (b'AC_output_absolute', b'W'), (b'minutes_last_contact', b'min'), (b'daily_battery_charge', b'Wh'), (b'daily_grid_outage_n', b'minute'), (b'daily_grid_outage_t', b''), (b'daily_grid_usage', b'Wh'), (b'daily_no_of_alerts', b'alert'), (b'daily_power_cons_pv', b'W'), (b'daily_power_consumption_total', b'Wh'), (b'daily_pv_yield', b'Wh')], default=0, verbose_name=b'Data Point Name')),
            ],
        ),
        migrations.CreateModel(
            name='Data_Process_Rule',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('function_type', models.CharField(choices=[(b'mean', b'average'), (b'sum', b'aggregate'), (b'min', b'minimum'), (b'max', b'maximum'), (b'mid', b'median'), (b'std', b'standard deviation')], default=b'aggregate', max_length=40)),
                ('duration', models.CharField(choices=[(b'12h', b'12 hours'), (b'24h', b'24 hours'), (b'48h', b'48 hours'), (b'7d', b'7 days'), (b'31d', b'1 month')], default=b'24h', max_length=40)),
                ('interval', models.CharField(choices=[(b'5m', b'5 minutes'), (b'10m', b'10 minutes'), (b'30m', b'30 minutes'), (b'1h', b'1 hour'), (b'2h', b'2 hours'), (b'5h', b'5 hours')], default=b'5m', max_length=10)),
                ('input_field', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='seshdash.Daily_Data_Point')),
            ],
        ),
        migrations.CreateModel(
            name='RMC_status',
        ...
        migrations.AddField(
            model_name='data_process_rule',
            name='output_field',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='seshdash.Trend_Data_Point'),
        ),
        migrations.AddField(
            model_name='data_process_rule',
            name='site',
